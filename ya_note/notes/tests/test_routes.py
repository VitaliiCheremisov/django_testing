...
class TestRoutes(TestCase):
    ...
    def test_redirects(self):
        ...
        """
        for name in self.test_urls.REDIRECTS_WITH_SLUG:
            args = (self.note.slug,)
            self.redirects_checker(name=name, args=args)
        for name in self.test_urls.REDIRECTS_WITHOUT_SLUG:
            self.redirects_checker(name=name)

    def redirects_checker(self, name, args=None):
